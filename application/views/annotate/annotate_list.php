...
<body id="annotate-panel">
	...
	<div id="main">
	    ...
	    <div id="article_area">
	    	<h2><span class="pink"><?php echo $res_title; ?> »</span></h2>
			<div id="tool" class="invis"></div>		
			<table id="ul_area">
			<?php foreach($units as $key => $unit){ ?>
				<tbody class = "unit_list">	
					<tr>
						<td class="button_area">
							<input type="button" class="list_annotate_button" id="la_button_<?php echo $key; ?>" value="标注"/>	
						</td>
						<td class="note_area">
							<span class="la_note" id="la_note_<?php echo $key; ?>">未标注</span>		
						</td>
						<td class="pre_area">
							<pre class="text_area"><?php echo $unit['content']; ?></pre>		
						</td>													
					</tr>
				</tbody>
			<?php } ?>	
